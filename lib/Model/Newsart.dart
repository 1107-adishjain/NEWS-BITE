...
// backend se data ko frontend me bhejne ke liye kuch process chaiye wo yeh method krke dega:
 ...
 static NewsArt Fromapitoapp(Map<String, dynamic> article) {
    return NewsArt(
        ...
        newshead: article["title"] ?? "Error: Failed to load data. This issue might be due to a variety of reasons. Firstly, please check your internet connection to ensure it is stable and working correctly. If your connection is fine, the problem could be on our end, possibly due to server issues or maintenance activities. Additionally, it could be a result of incorrect configurations or corrupted data files.",
        data: article["description"] ?? "Error Fail to Load Data:Error: Failed to load data. This issue might be due to a variety of reasons. Firstly, please check your internet connection to ensure it is stable and working correctly. If your connection is fine, the problem could be on our end, possibly due to server issues or maintenance activities. Additionally, it could be a result of incorrect configurations or corrupted data files.",
        newsurl: article["url"] ??"https://news.google.com/home?hl=en-IN&gl=IN&ceid=IN:en",
        newscnt: article["content"] ?? "Error Fail to Load Data:Error: Failed to load data. This issue might be due to a variety of reasons. Firstly, please check your internet connection to ensure it is stable and working correctly. If your connection is fine, the problem could be on our end, possibly due to server issues or maintenance activities. Additionally, it could be a result of incorrect configurations or corrupted data files."
        );
  }
}
